...
var marging = { top: 10, right: 30, bottom: 150, left: 50 },
    widthg = 10000 - marging.left - marging.right,
...
var svg = d3.select("#Area")
    ...
    .append("g")
    .attr("transform",
        "translate(" + marging.left + "," + marging.top + ")");
...
d3.csv("MPS_RESULTS_2021.csv", function (data) {
    ...
    data = d3.nest()
        ...
        .entries(data)
    var subgroups = ['NRM', 'INDEPENDENT', 'FDC']
    ...
    svg.append("g")
        ...
        .attr("height", function (d) { return heightg - y(d.value); })
